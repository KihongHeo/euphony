...
def lib():
  global _lib
  if _lib is None:
     _dirs = ['.', os.path.dirname(os.path.abspath(__file__)), os.path.join(sys.prefix, 'lib'), None]
     for _dir in _dirs:
       try:
          init(_dir)
          break
...
def Z3_mk_array_sort_n(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_array_sort_n is None:
     return
  r = _lib.Z3_mk_array_sort_n(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_select_n(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_select_n is None:
     return
  r = _lib.Z3_mk_select_n(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_store_n(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_store_n is None:
     return
  r = _lib.Z3_mk_store_n(a0, a1, a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_as_array(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_as_array is None:
     return
  r = _lib.Z3_mk_as_array(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
